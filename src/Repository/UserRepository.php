...
class UserRepository extends ServiceEntityRepository implements PasswordUpgraderInterface
{
     ...
     */
    public function findBySearchQuery(?string $query = null, ?string $role = null, ?string $status = null, ?string $sortBy = 'dateInscription', ?string $sortDirection = 'DESC', bool $reactivationOnly = false): array
    {
        ...
        if ($reactivationOnly) {
            $qb->andWhere('u.demandeReactivation = :reactivationOnly')
               ->setParameter('reactivationOnly', true);
        }
