...
{
    /** @return array<string, mixed>|list<array<string, mixed>>|list<string> */
    ...
    /** @return array<string, mixed> */ private function getStatistics(): array
    {
        ...
        foreach ($ageStatsRaw as $dto) {
            $labelIndex = array_search($dto->ageRange, $ageLabels);
            if ($labelIndex !== false) {
                if ($dto->sex === 'H') {
                    $maleData[$labelIndex] = (int) $dto->count;
                } elseif ($dto->sex === 'F') {
                    $femaleData[$labelIndex] = (int) $dto->count;
                }
            }
        }
