...
abstract class User implements UserInterface, PasswordAuthenticatedUserInterface
{
    ...
    public function setMotDePasse(#[\SensitiveParameter] string $motDePasse): static
    {
    ...
    public function setResetTokenExpiresAt(#[\SensitiveParameter] ?\DateTimeImmutable $resetTokenExpiresAt): static
    {
